"""Tests for earnings_iv_crush.data.config: .env parsing and the require() guard."""

from __future__ import annotations

import pytest

from earnings_iv_crush.data import config
...
def test_parse_env_basic():
    ...
    assert parsed["SEC_USER_AGENT"] == "Jane Doe jane.doe@example.com"
