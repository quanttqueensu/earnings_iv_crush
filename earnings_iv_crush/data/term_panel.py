...
The term gate compares each event's front-minus-back ATM IV against the trailing
30-DAY distribution of that name's term spread. That needs a *daily*
...
def build_term_panel(
    ...
    *,
    ...
    fetch_chain = fetch_chain or partial(
        alpaca_options.fetch_option_chain, strike_window=strike_window, horizon_days=horizon_days
    )
