...
def _straddle_value(spot: float, strike: float, t: float, r: float, sigma: float) -> float:
...
def delta_hedge_pnl(
    ...
    """
    P&L of the once-at-entry-close delta hedge of a short straddle.
